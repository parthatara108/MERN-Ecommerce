...
import { createBrandAsync, createCategoryAsync } from '../../products/productsSlice';
...
const BrandForm = () => {
    ...
    return (
        <form noValidate className="space-y-6 px-4 sm:px-0 sm:mx-auto sm:max-w-lg" onSubmit={handleSubmit((data) => {
            const label = { ...data }
            dispatch(createBrandAsync({ brand: label, alert }));
            reset();
        })}>
            <div className="space-y-6 bg-white p-6">
                <div className=" border-gray-900/10 pb-6">
                    <h2 className="text-xl font-semibold leading-7 text-gray-900">Add Brand</h2>
                </div>
